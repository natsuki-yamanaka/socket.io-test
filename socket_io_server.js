...
io.sockets.on('connection', function(socket){
	...
	//declare socket.on----------------------------------------//
	socket.on('fileOpen', 			function(data){fileOpen(socket,data)});
	...
	//---------------------------------------------------------------------------------//
	/** main */
	var fileOpen = function(socket,data){
		logger('eventOn fileOpen:' + util.inspect(data,false,null));
		var event = 'fileOpened';
